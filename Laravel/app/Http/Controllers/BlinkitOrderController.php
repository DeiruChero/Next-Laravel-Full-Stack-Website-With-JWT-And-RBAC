...
class BlinkitOrderController extends Controller
{
    public function index()
    {
        $platforms = QuickCommerceModel::where('ProductName', 'NameBlinkit')
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => 'Blinkit Order created successfully!']);
    }
    ...
    public function orderEditBlinkit(Request $request, $id)
    {
        $validated = $request->validate([
        ...
        return response()->json(['message' => 'Blinkit order updated successfully.']);
    }
}
