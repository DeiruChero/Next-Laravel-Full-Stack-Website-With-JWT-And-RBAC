...
class SwiggyOrderController extends Controller
{
    public function index()
    {
        $platforms = QuickCommerceModel::where('ProductName', 'NameSwiggy')
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => 'Swiggy Order created successfully!']);
    }
    ...
    public function orderEditSwiggy(Request $request, $id)
    {
        $validated = $request->validate([
        ...
        return response()->json(['message' => 'Swiggy order updated successfully.']);
    }
}
