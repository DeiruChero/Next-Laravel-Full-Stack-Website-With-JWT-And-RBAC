...
export default function DistributorCreate() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (/^[A-Z]{0,5}[0-9]{0,4}[A-Z]{0,1}$/.test(formData.PanNo) && formData.PanNo.length != 10) {
            setErrors('Pan number must be exactly 10 digits.');
            setSuccessMsg('');
            return;
        }

        if (/^[0-9]{0,12}$/.test(formData.AdharNo) && formData.AdharNo.length != 12) {
            setErrors('Adhar number must be exactly 12 digits.');
            setSuccessMsg('');
            return;
        }
        ...
        try {
            ...
            setSuccessMsg('Distributor created successfully! 🎉');
            setFormData({
                DisplayName: '',
                Email: '',
                Mobile: '',
    ...
    return (
        <div className="container" style={{ marginTop: '50px' }}>
            <h2 className="text-center mb-4 text-primary">Create Distributor</h2>
            ...
            <div className="card shadow-lg bg-light">
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <label className="form-label fw-bold">Distributor Name <span className='text-danger'>*</span></label>
                            <input
                                type="text"
                            ...
                            <div className="mb-3 col-md-6">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (/^[A-Z]{0,5}[0-9]{0,4}[A-Z]{0,1}$/.test(input) && input.length <= 10) {
                                            setFormData({ ...formData, PanNo: input });
                                        }
                                    }}
                                    placeholder="Enter pan number"
                                />
                                {errors.PanNo && <div className="invalid-feedback">{errors.PanNo[0]}</div>}
                            </div>
                            <div className="mb-3 col-md-6">
                                <label className="form-label fw-bold">Adhaar Number <span className='text-danger'>*</span></label>
                                <input
                                    type="number"
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (/^[0-9]{0,12}$/.test(input)) {
                                            setFormData({ ...formData, AdharNo: input });
                                        }
                                    }}
                                    placeholder="Enter Adhaar Number"
                                />
                                {errors.AdharNo && <div className="invalid-feedback">{errors.AdharNo[0]}</div>}
                            </div>
                        </div>
                        ...
                        <div className='mb-3'>
                            ...
                            <textarea className="form-control" name="Address" value={formData.Address} onChange={handleChange} required placeholder='Distributor Address'></textarea>
                        </div>
