            ...
            <div className="card shadow-lg bg-light">
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <label className="form-label fw-bold">Customer's Name <span className='text-danger'>*</span></label>
                            <input
                                type="text"
                        ...
                        <div className='mb-3'>
                            ...
                            <textarea className="form-control" name="Address" value={formData.Address} onChange={handleChange} required placeholder='Enter Customer&apos;s Home Address'></textarea>
                        </div>
                        ...
                        <div className="mb-3">
                            <label className="form-label fw-bold">Customer's Picture</label>
                            <input
                                type="file"
