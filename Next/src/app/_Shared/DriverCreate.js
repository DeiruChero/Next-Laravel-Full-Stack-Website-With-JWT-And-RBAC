...
export default function DriverCreate() {
    ...
    return (
        <div className="container" style={{ marginTop: '50px' }}>
            <h2 className="text-center mb-4 text-primary">Create Driver</h2>
            ...
            <div className="card shadow-lg bg-light">
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <label className="form-label fw-bold">Driver Name <span className='text-danger'>*</span></label>
                            <input
                                type="text"
                        ...
                        <div className="row">
                            ...
                            <div className="mb-3 col-md-6">
                                <label className="form-label fw-bold">Vehicle <span className='text-danger'>*</span></label>
                                <select
                                ...
                                {errors.VehicleID && <div className="invalid-feedback">{errors.VehicleID[0]}</div>}
                            </div>
                        </div>
