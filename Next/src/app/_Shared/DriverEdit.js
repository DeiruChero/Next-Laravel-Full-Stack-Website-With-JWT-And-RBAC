...
export default function DriverEdit({ params }) {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            try {
                ...
                if (user.VehicleID) {
                    const vehicleRes = await api.get(`vehicle-show/${user.VehicleID}`);
                    setVehicle(vehicleRes.data.VehicleName);
                }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await api.put(`update-driver/${UserID}`, {
                Area: area,
                PinCode: pincode,
                Salary: salary,
                RoleID: roleId
    ...
    return (
        <div className="container mt-5">
            <h2 className="text-center mb-4 text-warning">Edit Driver</h2>
            ...
            <form onSubmit={handleSubmit} className="shadow p-4 rounded bg-white">
                ...
                <div className="row">
                    ...
                    <div className="mb-3 col-md-6">
                        ...
                        <input className='form-control' value={vehicle} disabled></input>
                    </div>
                </div>
                <div className="row">
