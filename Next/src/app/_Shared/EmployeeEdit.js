...
export default function EmployeeEdit({ params }) {
        ...
        const fetchUser = async () => {
            try {
                ...
                if (user.DesignationID) {
                    const designationRes = await api.get(`designation-show/${user.DesignationID}`);
                    setDesignation(designationRes.data.DesignationName);
                }
                setGender(user.Gender);
                setDob(user.DateofBirth);
                setDoj(user.DateJoined);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await api.put(`update-employee/${UserID}`, {
                Area: area,
                PinCode: pincode,
                Salary: salary,
                RoleID: roleId
    ...
    return (
        <div className="container mt-5">
            <h2 className="text-center mb-4 text-warning">Edit Employee</h2>
            ...
            <form onSubmit={handleSubmit} className="shadow p-4 rounded bg-white">
                ...
                <div className="row">
                    <div className="mb-3 col-md-6">
                        ...
                        <input className='form-control' value={gender} disabled></input>
                    </div>
                    <div className="mb-3 col-md-6">
                        <label className='form-label fw-bold'>Designation</label>
                        <input className='form-control' value={designation} disabled></input>
                    </div>
                </div>
                <div className="row">
                    <div className="mb-3 col-md-4">
                        <label className='form-label fw-bold'>Date Of Birth</label>
                        <input className='form-control' value={dob} disabled></input>
                    </div>
                    <div className="mb-3 col-md-4">
                        <label className='form-label fw-bold'>Date Of Joining</label>
                        <input className='form-control' value={doj} disabled></input>
                    </div>
                    <div className="mb-3 col-md-4">
