...
export default function OrderCancelCustomerView() {
    ...
    useEffect(() => {
        api.get('ordercancelcustomer-data', {
            params: {
                page: pageIndex + 1,
                limit: pageSize,
                search: globalFilter,
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <button
                    ...
                    onClick={() => router.push(`/Dashboard/ordercancelcustomer/ordercancelcustomerconfirm/${row.original.OrderID}`)}
                >
                    Cancel
                </button>
            ),
