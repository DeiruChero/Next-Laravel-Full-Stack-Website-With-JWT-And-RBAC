...
export default function PackingMaterialEdit() {
    ...
    { accessorKey: 'PackagingCost', header: 'Packaging Cost (Rs.)' },
    {
      ...
      cell: ({ row }) => (
        <button
          ...
          onClick={() => router.push(`/Dashboard/packingmaterialedit/packingmaterialeditconfirm/${row.original.PackingMaterialID}`)}
        >
          Edit
        </button>
      ),
