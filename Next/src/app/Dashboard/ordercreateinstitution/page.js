...
export default function InstitutionOrderCreate() {
    ...
    useEffect(() => {
        const fetchClients = async () => {
            try {
                const res = await api.get('/institutionordercreate-data');
                setClients(res.data);
            } catch (error) {
    ...
    const handleClientBlur = () => {
        const match = clients.find(
            client => client.DisplayName.trim().toLowerCase() === selectClient.trim().toLowerCase()
        );
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMsg('Institution order created successfully! 🎉');
            setErrorMsg('');
            setOrderNo('');
            setDate('');
            setSelectClient('');
    ...
    return (
        <div className="container mt-5">
            <h2 className="mb-4 text-success fw-bold">Institution Order Create</h2>
            ...
            <form onSubmit={handleSubmit} className="shadow p-4 rounded bg-light">
                ...
                <div className="row">
                    <div className="mb-3 col-md-10">
                        ...
                        <datalist id="client-options">
                            {clients.map(client => (
                                <option key={client.UserID} value={client.DisplayName} />
                            ))}
                        </datalist>
                    </div>
                ...
                <button type="submit" className="btn shadow btn-primary w-100" disabled={loading}>
                    ...
                    {loading ? ' Creating...' : 'Institution Order Create'}
                </button>
            </form>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content shadow-lg">
                            ...
                            <div className="modal-body">
                                <p><strong>Client Type:</strong> Institution</p>
