...
export default function CustomerOrderCreate() {
    ...
    useEffect(() => {
        const fetchClients = async () => {
            try {
                const res = await api.get('/customerordercreate-data');
                setClients(res.data);
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMsg('Customer order created successfully! 🎉');
            setErrorMsg('');
            setOrderNo('');
            setDate('');
            setSelectClient('');
    ...
    return (
        <div className="container mt-5">
            <h2 className="mb-4 text-success fw-bold">Customer Order Create</h2>
            ...
            <form onSubmit={handleSubmit} className="shadow p-4 rounded bg-light">
                ...
                <button type="submit" className="btn shadow btn-primary w-100" disabled={loading}>
                    ...
                    {loading ? ' Creating Order...' : 'Customer Order Create'}
                </button>
            </form>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content shadow-lg">
                            ...
                            <div className="modal-body">
                                <p><strong>Client Type:</strong> Customer</p>
