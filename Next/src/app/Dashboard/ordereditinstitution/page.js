...
export default function OrderEditInstitutionView() {
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <button
                    ...
                    onClick={() => router.push(`/Dashboard/ordereditinstitution/ordereditinstitutionconfirm/${row.original.OrderID}`)}
                >
                    Edit
                </button>
            ),
