...
export default function PackingMaterialDelete() {
    ...
    { accessorKey: 'PackagingCost', header: 'Packaging Cost (Rs.)' },
    {
      ...
      cell: ({ row }) => (
        <button
          ...
          onClick={() => router.push(`/Dashboard/packingmaterialdelete/packingmaterialdeleteconfirm/${row.original.PackingMaterialID}`)}
        >
          Delete
        </button>
      ),
