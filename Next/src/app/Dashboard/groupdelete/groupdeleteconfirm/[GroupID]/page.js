...
export default function GroupDelete({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push('/Dashboard/groupdelete');
    } catch (err) {
  ...
  return (
    <div className="container mt-5">
      <h2 className="text-center mb-4">Delete Product Group</h2>
      ...
      <form onSubmit={handleSubmit} className="shadow p-4 rounded bg-white">
        ...
        <button type="submit" className="btn btn-danger w-100 mb-3" disabled={loading}>
          ...
          {loading ? ' Deleting...' : 'Delete Product Group'}
        </button>
