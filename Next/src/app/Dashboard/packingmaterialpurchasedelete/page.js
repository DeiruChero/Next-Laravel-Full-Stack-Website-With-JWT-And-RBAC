...
export default function PackingMaterialPurchaseView() {
    ...
    { accessorKey: 'VendorName', header: 'Vendor Name' },
    {
      ...
      cell: ({ row }) => (
        <button
          ...
          onClick={() => router.push(`/Dashboard/packingmaterialpurchasedelete/packingmaterialpurchasedeleteconfirm/${row.original.PurchaseID}`)}
        >
          Delete
        </button>
      ),
