...
export default function OrderEditCustomerView() {
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <button
                    ...
                    onClick={() => router.push(`/Dashboard/ordereditcustomer/ordereditcustomerconfirm/${row.original.OrderID}`)}
                >
                    Edit
                </button>
            ),
