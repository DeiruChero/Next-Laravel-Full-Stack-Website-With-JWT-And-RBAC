...
export default function OrderEditSwiggyView() {
    ...
    useEffect(() => {
        api.get('ordercancelswiggy-data', {
            params: {
                page: pageIndex + 1,
                limit: pageSize,
                search: globalFilter,
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <button
                    ...
                    onClick={() => router.push(`/Dashboard/ordereditswiggy/ordereditswiggyconfirm/${row.original.OrderID}`)}
                >
                    Edit
                </button>
            ),
