...
export default function VendorEdit({ params }) {
        ...
        const fetchVendor = async () => {
            try {
                ...
                setFormData({
                    ...
                    Mobile3: vendor.Mobile3 || '',
                    VenderType: vendor.VenderType || '',
                    BenificiaryName: vendor.BenificiaryName || '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setErrors({});
            setSuccessMsg('Vendor Updated Successfully 🎉');
            router.push('/Dashboard/vendoredit');
        } catch (err) {
    ...
    return (
        <div className="container" style={{ marginTop: '50px' }}>
            <h2 className="text-center mb-4 text-warning">Edit Vendor</h2>
