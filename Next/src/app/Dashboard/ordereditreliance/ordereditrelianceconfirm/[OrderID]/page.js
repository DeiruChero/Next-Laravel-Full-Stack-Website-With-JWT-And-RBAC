...
export default function OrderEditRelianceConfirm({ params }) {
    ...
    useEffect(() => {
        ...
        const fetchOrder = async () => {
            try {
                const res = await api.get(`ordercancelreliance-show/${OrderID}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            router.push('/Dashboard/ordereditreliance');
        } catch (err) {
    ...
    return (
        <div className="container mt-5">
            <h2 className="text-center mb-4 fw-bold text-warning">Edit Reliance's Order</h2>
